...
class TestWeightConverter(unittest.TestCase):
    ...
    def test_gram(self):
        test = self.grams
        self.assertEqual(1.0, test.convert_to_grams(), msg="Expects a float or 1.0")
        self.assertEqual(THOUSAND, test.convert_to_milligrams(), msg="Expects a float or 1000.0")
        self.assertEqual(0.001, test.convert_to_kilograms(), msg="Expects a float or 0.001")
